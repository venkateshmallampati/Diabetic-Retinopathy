...
# model.load_weights(r"C:\Users\Lakshman\Downloads\ANU VVIT PROJECTS\diabetic\final_model_weights.weights.h5")

# Define class labels (Modify this according to your classes)
class_labels = ["No DR", "Mild", "Moderate", "Severe", "Proliferative DR"]

# Streamlit UI
st.title("Diabetic Retinopathy Classification using DENSE-NET-121")
st.write("Upload a image to get a prediction.")
